...
const ItemShape = memo(function ItemShape({ item, selected, onPointerDown }) {
  ...
  const selRing = selected
    ? <rect x={-2} y={-2} width={w + 4} height={h + 4} fill="none" stroke="#3b82f6" strokeWidth={2} strokeDasharray="6,3" style={{ pointerEvents: 'none' }} />
    : null;
